...
class HomeViewActivity : Activity(), HomeView {
    ...
    override fun navigateToOtherDetails(artistName: String) {
        val intent = Intent(this, ayds.songinfo.moredetails.presentation.MoreDetailsViewActivity::class.java)
        intent.putExtra(ayds.songinfo.moredetails.presentation.MoreDetailsViewActivity.ARTIST_NAME_EXTRA, artistName)
